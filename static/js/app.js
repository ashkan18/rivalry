...
//Set up the triggers for the arrow keys
    ...
    parallax.mainCatalog.onload=function(){
        setRight("mozhSide", "Mozh Side");
        setBottom("nextCatalog", "Prev Month");
        setLeft("ashSide","Ash side");
    };

    parallax.nextCatalog.onload=function(){
        setBottom("index","Home");
    };

    parallax.mozhSide.onload=function(){
        setLeft("mainCatalog", "Home");
    };

    parallax.ashSide.onload=function(){
        setRight("mainCatalog","Home");
    };
